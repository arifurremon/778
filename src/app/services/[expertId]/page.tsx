          ...
          <div className="absolute -bottom-16 left-8 md:left-16 flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-8">
            ...
            <div className="space-y-3 pb-2 text-center md:text-left">
               ...
               <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm text-muted-foreground font-bold uppercase tracking-widest">
                  <span className="flex items-center gap-1.5 text-accent"><Award size={16} /> {expert.profession}</span>
                  <span className="flex items-center gap-1.5"><MapPin size={16} className="text-primary" /> {expert.location}</span>
                  <span className="flex items-center gap-1.5"><Star size={16} className="fill-accent text-accent" /> {expert.rating} ({expert.reviews} Reviews)</span>
               </div>
            </div>
          </div>
        </div>
