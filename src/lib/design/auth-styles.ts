...
export const authStyles = {
  ...
  input:
    "h-12 px-5 rounded-2xl bg-white/70 border border-border/60 focus:border-auth-brand focus:ring-2 focus:ring-auth-brand/25 transition-all text-foreground placeholder:text-muted-foreground font-medium shadow-sm hover:border-border",
  inputWithToggle:
    "h-12 px-5 rounded-2xl bg-white/70 border border-border/60 focus:border-auth-brand focus:ring-2 focus:ring-auth-brand/25 transition-all text-foreground placeholder:text-muted-foreground font-medium shadow-sm hover:border-border pr-12",
  selectTrigger:
    "h-12 px-5 rounded-2xl bg-white/70 border-2 border-border/80 focus:border-auth-brand focus:ring-2 focus:ring-auth-brand/25 transition-all text-foreground w-full text-left font-bold shadow-md hover:border-border text-base",
  buttonPrimary:
